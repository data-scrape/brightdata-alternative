#!/usr/bin/env python3
"""
brightdata-alternative - Bright Data to CoreClaw Migration Demo

This script demonstrates how to migrate from Bright Data to CoreClaw's Web Data API.
...
class BrightdataAlternative:
    """Demo: Migrate from Bright Data to CoreClaw Web Data API."""
...
def main():
    parser = argparse.ArgumentParser(description="brightdata-alternative - Bright Data to CoreClaw Migration")
    ...
    client = BrightdataAlternative(api_key=args.api_key)
